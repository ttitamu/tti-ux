...
const navTree = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "TuxAbstract",      to: "/components/research-publishing", icon: "lucide:file-text" },
      { label: "TuxAccordion",     to: "/components/accordion",      icon: "lucide:chevrons-up-down" },
      { label: "TuxAcknowledgments", to: "/components/research-publishing", icon: "lucide:hand-heart" },
      { label: "TuxAuthorByline",  to: "/components/research-publishing", icon: "lucide:users" },
      ...
      { label: "TuxCenterBadge",   to: "/components/tti-identity",   icon: "lucide:landmark" },
      ...
      { label: "TuxCommentThread", to: "/components/comment-thread",  icon: "lucide:message-square-quote" },
      { label: "TuxConfirmDialog", to: "/components/forms-wrapper",  icon: "lucide:check-square" },
      ...
      { label: "TuxCorridorStrip", to: "/components/geospatial",     icon: "lucide:route" },
      ...
      { label: "TuxFAB",           to: "/components/fab",            icon: "lucide:circle-plus" },
      ...
      { label: "TuxFileDropzone",  to: "/components/forms-wrapper",  icon: "lucide:upload-cloud" },
      { label: "TuxFocusView",     to: "/components/focus-view",     icon: "lucide:focus" },
      { label: "TuxFooter",        to: "/components/footer",         icon: "lucide:panel-bottom" },
      { label: "TuxFormField",     to: "/components/forms-wrapper",  icon: "lucide:form-input" },
      { label: "TuxFundingSource", to: "/components/tti-identity",   icon: "lucide:hand-coins" },
      ...
      { label: "TuxInfiniteScroll", to: "/components/infinite-scroll", icon: "lucide:chevrons-down" },
      ...
      { label: "TuxLab",           to: "/components/tti-identity",   icon: "lucide:flask-conical" },
      ...
      { label: "TuxLoadMore",      to: "/components/load-more",      icon: "lucide:plus-circle" },
      { label: "TuxMapEmbed",      to: "/components/geospatial",     icon: "lucide:map" },
      { label: "TuxMarkdownEditor", to: "/components/forms-wrapper", icon: "lucide:edit-3" },
      { label: "TuxMapLegend",     to: "/components/geospatial",     icon: "lucide:list-tree" },
      { label: "TuxMapMarker",     to: "/components/geospatial",     icon: "lucide:map-pin" },
      { label: "TuxMcpEmbed",      to: "/components/mcp-embed",      icon: "lucide:plug" },
      { label: "TuxMediaSlab",     to: "/components/media-slab",     icon: "lucide:image-plus" },
      { label: "TuxMenuBar",       to: "/components/menu-bar",       icon: "lucide:menu" },
      { label: "TuxMobileFrame",   to: "/components/mobile-frame",   icon: "lucide:smartphone" },
      ...
      { label: "TuxProgram",       to: "/components/tti-identity",   icon: "lucide:milestone" },
      ...
      { label: "TuxResultCount",   to: "/components/result-count",   icon: "lucide:sigma" },
      { label: "TuxRichDataGrid",  to: "/components/rich-data-grid", icon: "lucide:layout-grid" },
      { label: "TuxRichTextEditor", to: "/components/rich-text-editor", icon: "lucide:pen-line" },
      { label: "TuxRuleBuilder",   to: "/components/rule-builder",   icon: "lucide:filter" },
      ...
      { label: "useTuxSwipe",      to: "/components/swipe",          icon: "lucide:move-horizontal" },
      { label: "TuxTable",         to: "/components/table",          icon: "lucide:table" },
      { label: "TuxTabBar",        to: "/components/tab-bar",        icon: "lucide:layout-panel-top" },
      { label: "TuxTabs",          to: "/components/tabs",           icon: "lucide:rectangle-vertical" },
      ...
      { label: "TuxTooltip",       to: "/components/tooltip",        icon: "lucide:message-square-quote" },
      ...
      { label: "TuxValidationSummary", to: "/components/forms-wrapper", icon: "lucide:alert-circle" },
    ],
  },
  {
    label: "Composition",
