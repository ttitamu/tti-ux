...
const components = [
  ...
  { name: "TuxCommentThread", to: "/components/comment-thread",  blurb: "Peer-review / editorial threads — root + replies, @mentions, resolve/reopen, edit/delete own.", uses: "tux (no U-primitive)" },
  ...
  { name: "TuxMcpEmbed",      to: "/components/mcp-embed",      blurb: "Frame for interactive third-party MCP app output — app icon + name + window controls + skeleton. Sister to TuxArtifact.", uses: "tux (no U-primitive)" },
  ...
  { name: "TuxMobileFrame",   to: "/components/mobile-frame",   blurb: "Stylized device chrome for screenshots — iOS (iPhone) or Android (Pixel) via platform prop. Doc-only marketing helper.", uses: "tux (no U-primitive)" },
  ...
  { name: "TuxPopover",       to: "/components/popover",        blurb: "Richer-than-tooltip floating panel — title + body + actions. Maroon hairline rule under title. Click default; hover for read-only.", uses: "UPopover" },
  ...
  { name: "TuxRailNav",       to: "/components/rail-nav",       blurb: "Collapsible sidebar/rail navigation — native <details> disclosure groups (accessible without roleless aria-expanded), icon-only collapsed mode. tux-owned replacement for UNavigationMenu in app shells.", uses: "tux (no U-primitive)" },
  ...
  { name: "TuxRichTextEditor", to: "/components/rich-text-editor", blurb: "Canonical WYSIWYG — Tiptap-based, 7 toolbar groups, tables, task lists, source-mode toggle, full-screen, syntax highlighting.", uses: "Tiptap + lowlight" },
  { name: "TuxRuleBuilder",   to: "/components/rule-builder",   blurb: "Relational query UI — field + operator + value rows, AND/OR groupers, nestable. Sister to faceted TuxFilterPanel.", uses: "tux (no U-primitive)" },
  ...
  { name: "TuxUtilityCluster", to: "/components/utility-cluster", blurb: "The trailing app-control cluster — search · notifications · theme · waffle · identity in law-fixed DOM order. Registry-fed waffle + role=status theme announcements.", uses: "tux (composes TuxAppSwitcher + TuxUserMenu)" },
  { name: "TuxUserMenu",      to: "/components/utility-cluster", blurb: "The suite's one identity affordance — cluster chip or rail-footer mount, state-complete (loading / signed-out / signed-in / local-only / error), law-fixed menu order.", uses: "UDropdownMenu" },
